...
COMMAND_HANDLERS = [
    ...
    ('create_room', create_room_handler.handle_create_room, 2),
    ('join_room', join_room_handler.handle_join_room, 2),
    ('start_game', admin_handlers.handle_start_game, 2),
    ('kick', admin_handlers.handle_kick_player, 3),
    ('stop_game', admin_handlers.handle_stop_game, 3),
    ('start_discussion', admin_handlers.handle_start_discussion, 3),
    ('end_discussion', admin_handlers.handle_end_discussion, 3),
    ('vote', lambda b, m: admin_handlers.handle_vote_command(b, m.chat.id), 3),
    ('show_status', game_handlers.handle_show_status, 2),
    ('leave_room', game_handlers.handle_leave_room, 3),
